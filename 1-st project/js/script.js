window.addEventListener('DOMContentLoaded', function() {
    ...
    const calcTotal = document.querySelector(".calculating__result span");
    ...
    function initializeStaiticInformation (selector, activeClass) {
    ...
    initializeStaiticInformation("#gender div", "calculating__choose-item_active");
    initializeStaiticInformation(".calculating__choose_big div", "calculating__choose-item_active");
